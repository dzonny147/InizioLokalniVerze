...
app.post('/api/search', async (req, res) => {
    ...
    console.log('Přijatý text:', inputText);
    ...
    try {
        ...
        console.log('Počet nalezených výsledků:', searchResults.length);
        ...
        // Ujistěte se, že složka 'download' existuje
        ...
        // Uložení CSV do složky 'download'
        const csvPath = path.join(downloadDir, `result-${searchTerm}-${timestamp}.csv`);
        fs.writeFileSync(csvPath, csvContent);


        // response with link for download of file
        res.json({ downloadLink: `${csvPath}` });
